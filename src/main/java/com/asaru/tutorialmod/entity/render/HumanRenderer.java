package com.asaru.tutorialmod.entity.render;
...
public class HumanRenderer extends BipedRenderer<AndroidEntity, PlayerModel<AndroidEntity>> {
    protected static final ResourceLocation TEXTURE = new ResourceLocation(TutorialMod.MOD_ID, "textures/entity/synth2.png");
    public HumanRenderer(EntityRendererManager context) {
        super(context, new PlayerModel<>(0.0F, false), 0.5f);
        this.addLayer(new BipedArmorLayer<>(this, new BipedModel(0.5F), new BipedModel(1.0F)));
    }

    public void render(AndroidEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
        this.setModelProperties(p_225623_1_);
        super.render(p_225623_1_, p_225623_2_, p_225623_3_, p_225623_4_, p_225623_5_, p_225623_6_);
    }

    private void setModelProperties(AndroidEntity companion) {
        PlayerModel<AndroidEntity> companionModel = this.getModel();
    ...
    private static BipedModel.ArmPose getArmPose(AndroidEntity companion, Hand hand) {
    ...
    protected void scale(AndroidEntity p_117798_, MatrixStack p_117799_, float p_117800_) {
        float f = 0.9375F;
